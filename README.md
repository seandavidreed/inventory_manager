...
- Select users, then root, and update email field with a valid address.  
- Select Suppliers and update each email field with a valid address.

#### Authorize Inventory Manager to Access Gmail
- To let your gmail be accessed by Inventory Manager, navigate to *Manage your Google Account*.   
- Go to *Security* and select *App Passwords*. In the dropdown *Select App* menu, select *Mail*.  
- After selecting your device and hitting generate, copy the app password to your clipboard.

#### Generate A Secret Key
```
cd inventory_manager/mysite
python3

>>> from django.core.management.utils import get_random_secret_key
>>> print(get_random_secret_key())
```
- Copy the random secret key to the clipboard.

#### Putting It All Together
- Create a .env file
```
cd inventory_manager/mysite/mysite
touch .env
```
...
- Populate .env with the following values  
    ...
    RECIPIENT_ADDRESS=your_email@example.com  
    SECRET_KEY='\<PASTE RANDOM SECRET KEY>'
